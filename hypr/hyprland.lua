...
hl.on("hyprland.start", function()
	...
	hl.exec_cmd("hyprpaper & disown; sleep 0.2; ~/.config/hypr/random_wall.sh; ~/.config/waybar/gen_waybar_theme.sh;")
	-- hl.exec_cmd("~/.config/hypr/random_wall.sh")
	-- hl.exec_cmd("~/.config/waybar/gen_waybar_theme.sh")
